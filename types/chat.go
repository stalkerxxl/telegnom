...
type ChatFullInfo struct {
	...
	AvailableReactions                 []ReactionTypeData    `json:"available_reactions,omitempty"`
...
// EffectiveChat returns the chat to which the join request was sent.
func (r *ChatJoinRequest) EffectiveChat() *Chat {
	return r.Chat
}

// EffectiveUser returns the user who sent the join request.
func (r *ChatJoinRequest) EffectiveUser() *User {
	return r.From
}
